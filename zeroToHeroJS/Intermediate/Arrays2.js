...
const all_new_heros = [...marvel_heros , ...dc_heros]   //Spread two arrays -- like concat bur here more than two arrays can be used/spread.

console.log(all_new_heros)

const another_array = [1,2,3,[4,5,6],7,[6,7,[4,5]]]

const real_another_array = another_array.flat(Infinity)   // If you want the above array two come as one element at one index - infintiy represents the depth upto which you have make the array flat here it has to be 3 but infinity is nice to use if you don't the depth
